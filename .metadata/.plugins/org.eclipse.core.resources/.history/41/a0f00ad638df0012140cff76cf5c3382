...
package no.course.service.application.office.answer_os.generated;
...
/**
 * The <code>AnswerDefaultManager</code> class is generated by the Genova Service Generator from the object selection <code>Answer_os</code>.
 * <p>
 * The java file containing this class should not be altered. All changes will be lost when the class is regenerated.
 * <p>
 * The class contains all methods used to manipulate the object selection role <code>Answer</code>
 * <p>
 * The role Answer data objects are of class <code>no.course.domain.Answer</code>;
 * <p>
 * <code>Answer</code> is a root role.
 * <p>
 * The <code>Answer</code> is a leaf role in the object selection <code>Answer_os</code>
 * <p>
...
abstract public class AnswerDefaultManager extends Role {
    ...
    */
    ...
    /**
     * Hook method called at start of <code>cleanupResultAsTarget</code> for role <code>Answer</code>.
     * <p>
    ...
    /**
     * Hook method called at end of <code>cleanupResultAsTarget</code> for role <code>Answer</code>.
     *
    ...
    /**
     * Hook method called at start of <code>find</code> for role <code>Answer</code>.
     * <p>
     * When overriding this hook has three possible exits:
     * <ul>
    ...
    /**
     * Hook method called at end of <code>find</code> for <code>Answer</code>.
     * <p>
     *
    ...
    /**
     * Hook method called at start of <code>findAll</code> for role <code>Answer</code>.
     * <p>
     * When overriding this hook has three possible exits:
     * <ul>
    ...
    /**
     * Hook method called at end of <code>findAll</code> for <code>Answer</code>
     * <p>
     *
    ...
    /**
     * Hook method called at start of <code>save</code> for role <code>Answer</code>.
     * <p>
     * When overriding this hook has three possible exits:
     * <ul>
    ...
    /**
     * Hook method called at end of <code>save</code> for <code>Answer</code>.
     *
     * @param objectSelection The <code>ObjectSelection</code> with data from the database.
    ...
    /**
     * Hook method called at start of <code>insert</code> for role <code>Answer</code>.
     * <p>
     * When overriding this hook has three possible exits:
     * <ul>
    ...
    /**
     * Hook method called at end of <code>insert</code> for <code>Answer</code>.
     * <p>
     *
     * @param objectSelection The <code>ObjectSelection</code> with data from the database.
    ...
    /**
     * Hook method called at start of <code>update</code> for role <code>Answer</code>.
     * <p>
     * When overriding this hook has three possible exits:
     * <ul>
    ...
    /**
     * Hook method called at end of <code>update</code> for <code>Answer</code>.
     * <p>
     *
     * @param objectSelection The <code>ObjectSelection</code> with data from the database.
     * @param resultObject The <code>Answer</code> object that was updated.
    ...
    /**
     * Hook method called at start of <code>delete</code> for role <code>Answer</code>.
     * <p>
     * When overriding this hook has three possible exits:
     * <ul>
    ...
    /**
     * Hook method called at end of <code>delete</code> for <code>Answer</code>.
     * <p>
     *
     * @param objectSelection The <code>ObjectSelection</code> with data from the database.
     ...
     * @return The <code>Answer</code> object
     */
    final Object findRootObject(ObjectSelection objectSelection) {
        Object rootObject = null;
        if (objectSelection != null) {
            if (objectSelection.getCurrentRootName().equals("Answer")) {
                Collection roots = objectSelection.getRootObjects("Answer");
                if (roots != null) {
    ...
    final Object findTargetObject(ObjectSelection objectSelection) {
        ...
        if (objectSelection != null) {
            if (objectSelection.getCurrentRootName().equals("Answer")) {
                resultObject = objectSelection.getRootObjects("Answer");
                if (!(objectSelection.getTargetRoleName().equals("Answer")) && resultObject != null) {
     ...
     *
     * @param objectSelection The <code>ObjectSelection></code> to search
     * @return <code>Answer</code> is a root role. The method always return null.
     */
     ...
     * @param oldRoot The object <code>Answer</code> to remove as root.
     * @param newRoot The object <code>Answer</code> to insert as new  root.
     */
    final void changeRootObject(ObjectSelection objectSelection, Answer oldRoot, Answer newRoot) {
        if (objectSelection != null) {
            Collection collection = objectSelection.getRootObjects("Answer");
            if (collection != null) {
     ...
     * the method will use the main key to find the <code>Answer</code> object.
     * <p>
     *
     ...
     */
    public Answer save(Answer targetObject, ClientContext ctx, Session session) {
     ...
     */
    Answer insert(Answer targetObject, ClientContext ctx, Session session) {
        boolean setsContainAllRelated = getCurrentObjectSelection().getSetsContainAllRelated();
        Answer resultObject;
    ...
    public Answer insertSingle(Answer targetObject, String targetKey, FindData findData, ClientContext ctx, Session session) {
        ...
        if (!isIdentical(targetObject,resultObject)) {
            ...
            TriggerInvoker.invoke(resultObject,TriggerType.INSERT, getCurrentObjectSelection().getTargetRoleName().equals("Answer"), ctx, session);
     ...
     */
    public Answer update(Answer targetObject, ClientContext ctx, Session session) {
        boolean setsContainAllRelated = getCurrentObjectSelection().getSetsContainAllRelated();
        Answer resultObject;
    ...
    public Answer updateSingle(Answer targetObject, String targetKey, FindData findData, ClientContext ctx, Session session) {
        ...
        if (resultObject == null) {
            ...
            if (resultObject != null) {
                ...
                TriggerInvoker.invoke(resultObject,TriggerType.UPDATE, getCurrentObjectSelection().getTargetRoleName().equals("Answer"), ctx, session);
            }
            else {
                Object[] args = { "Answer", "Answer_os" };
     ...
     * @param session The <code>DataAccess</code> <code>Session</code>.
     */
        public void delete(Answer targetObject,ClientContext ctx,Session session) {
        Answer resultObject = null;
    ...
    public void deleteSingle(Answer object,ClientContext ctx,Session session) {
        if (hookDeleteSingleStart(object,ctx,session)) {
            ...
            TriggerInvoker.invoke(object,TriggerType.DELETE, getCurrentObjectSelection().getTargetRoleName().equals("Answer"), ctx, session);
        }
    ...
    /**
     * This method is part of the <code>Manager</code> Interface and connects a target object of class <code>Answer</code> to its parent node.
    ...
    /**
     * This method is part of the <code>Manager</code> Interface and disconnects a target object of class <code>Answer</code> from its parent node.
     * This is a root role and the method is dummy.
     *
     * @param objectSelection The object selection with all data from the client.
     * @param ctx The <code>ClientContext</code> desciption.
