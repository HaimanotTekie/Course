...
package no.course.service.empty_os;
...
/**
 * The <code>Empty_osOsManager</code> class was generated by the Genova Service Generator from the object selection <code>Empty_os</code>.
 * <p>
...
public class Empty_osOsManager extends OsManager {
    ...
    public static Role newRoleManager(String applicationName, String roleName) {
        ...
        String fullName = OsManager.createManagerClassName(roleName,"no.course.service.empty_os");
        try {
    ...
    public Role newManager(String applicationName, String roleName) {
        return Empty_osOsManager.newRoleManager(applicationName,roleName);
    }
