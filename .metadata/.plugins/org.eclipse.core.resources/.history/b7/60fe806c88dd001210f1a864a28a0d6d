 ...
 * Answer. This file is generated for each generation in
 * Genova. Do not make changes in this file. All user added code
 * should be done in class Answer.
 * To access mother application, use variable
 * 'application'.
 */ 
@SuppressWarnings("all")
public abstract class AnswerDefaultController implements GenovaDialogController {
    GenovaEnums applicationEnums;
    /** Holds the name of the server application */
    private String serverApplicationName = "Answer_appl";
    ...
    /** This is the entry point for the object selection node with name Answer. Use methods found in this class - do not access view directly! */
    public AnswerMethods theAnswer;
    ...
    String[] tabSequence = {"Answer.answerText","Answer.id","AnswerClearButton","AnswerSaveButton","AnswerDeleteButton"};
    ...
    HashMap tabListFromNodeNameAnswerClass = tabListFromNodeNameWindow;
    HashMap tabListFromComponentAnswerClass = tabListFromComponentWindow;
    
    HashMap tabListFromNodeNameAnswerData = tabListFromNodeNameAnswerClass;
    HashMap tabListFromComponentAnswerData = tabListFromComponentAnswerClass;
    
    HashMap tabListFromNodeNameAnswerButton = tabListFromNodeNameAnswerClass;
    HashMap tabListFromComponentAnswerButton = tabListFromComponentAnswerClass;
...
// Number used for uniqe identifying groups.
     ...
     * object is an instance of the class Answer_appl and can
     ...
     */     
    public AnswerDefaultController(ApplicationMethods app) { 
    ...
    public List getListblockStates(final List pathToTarget) {
        ...
        if (!SwingUtilities.isEventDispatchThread()) {
            ...
            try {
                ...
                if (msgID != null) {
                    Object[] msgArgs = {AnswerDefaultController.class, "getListblockStates", ex};
                    Message msg = MessageSystem.getMessageFactory().getMessage(msgID, msgArgs);
                    MessageSystem.getMessageDispatcher(MessageSystem.NO_INTERACTION).dispatch(msg);
                    throw new GenovaClientFrameworkException(ex, msg);
                }
    ...
    public void setListblockStates(final List selectedLines, final boolean doSelect) {
        ...
        if (!SwingUtilities.isEventDispatchThread()) {
            ...
            try {
                ...
                if (msgID != null) {
                    Object[] msgArgs = {AnswerDefaultController.class, "setListblockStates", ex};
                    Message msg = MessageSystem.getMessageFactory().getMessage(msgID, msgArgs);
                    MessageSystem.getMessageDispatcher(MessageSystem.NO_INTERACTION).dispatch(msg);
                    throw new GenovaClientFrameworkException(ex, msg);
                }
    ...
    public ECheckResult callHookCheckPrint(String roleName) {
        ...
        if (AnswerConst.Answer.OSRoleName.equals(roleName)) {
            return hookAnswerCheckPrint();
        }
    ...
    public boolean callCheckRowSelectHook(String roleName, int currentSelectionIndex, int newSelectionIndex) {
        if (AnswerConst.Answer.OSRoleName.equals(roleName)) {
            return hookCheckRowSelectAnswer(currentSelectionIndex, newSelectionIndex);
        }
    ...
    public ECheckResult callHookCheckRowSelect
        ...
        if (AnswerConst.Answer.OSRoleName.equals(roleName)) {
            return hookAnswerCheckRowSelect(oldSelection, newSelection);
        }        
    ...
    public boolean checkPrint() {
        boolean retVal = true;
        retVal = retVal && theAnswer.checkPrint();
     ...
     * AnswerView. A default implementation of this method
     * is generated in the AnswerController class.
     *
     ...
     */
    protected abstract AnswerDefaultView hookInstantiateView(AnswerDefaultController controller, GenovaEnums applicationEnums);
    ...
    public boolean checkClose() {
        ...
        retVal = retVal && theAnswer.checkClose();
        if (!retVal) {
            if (getView().isIcon()) {
                try {
...
//       }
    ...
    public void init() {
       ...
       theAnswer = new AnswerMethods(view, this, applicationEnums);
       RoleObject roleObjectAnswer = addRoleObject(Answer.class, new RoleObject("Answer"));
       roleObjectAnswer.setNode(theAnswer);
       roleObjectAnswer.addSimpleBlock(theAnswer);
//       view.setVisible(true);
//       if (getWindow() instanceof JInternalFrame) {
//           setAccessPolicy();
//       }
   ...
   public Map getRoleObjects() {
        ...
        class Task implements Runnable {
            ...
            public void doTask() {
                ...
                objectSelection = new ObjectSelection(rootName,
                        targetRoleName, getServerApplicationName(), "Answer_os");
    ...
    public ObjectSelection obtainObjectSelection() {
        class Task implements Runnable {
            ...
            public void doTask() {
                ...
                obtainedRoots.put("Answer", 
                        obtainObjectSelection(theAnswer, true));
    ...
    public void clearObjectSelection() {
        ...
        clearTool.clear("Answer");
    }


    private boolean checkClearObjectSelection() {
        boolean ok = true;
        ok = ok && theAnswer.checkChanged();
        if (!ok) {
    ...
    /** Set enable/disable for button AnswerClearButton 
     * @param b true for enabled, false for not 
     */
    public void setEnabledAnswerClearButton(boolean b) {
        view.AnswerClearButton.setEnabled(b);
    }
    
    /**
     * Shows or hides AnswerClearButton depending on the parameter.
     * @param b <code>true</code> to show, <code>false</code> to hide.
     */
    public void setShownAnswerClearButton(boolean b) {
        view.AnswerClearButton.setVisible(b);
    }
    
    /**
     * Attemts to transfer input focus to AnswerClearButton
     */
    public void setFocusAnswerClearButton() {
        view.AnswerClearButton.requestFocusInWindow();
    }
    
    /**
     * Check if AnswerClearButton is enabled.
     * @return <code>true</code> if AnswerClearButton is enabled.
     */
    public boolean isEnabledAnswerClearButton() {
        return view.AnswerClearButton.isEnabled();
    }
    
    /**
     * Check if AnswerClearButton is the focus owner.
     * @return <code>true</code> if AnswerClearButton is the focus owner.
     */
    public boolean hasFocusAnswerClearButton() {
        return view.AnswerClearButton.isFocusOwner();
    }
    
    /**
     * Check if AnswerClearButton is visible. Note that this does 
     * not imply that AnswerClearButton is actually showing, only that it can be 
     * drawn on the screen.
     * @return <code>true</code> if AnswerClearButton is visible.
     */
    public boolean isShownAnswerClearButton() {
        return view.AnswerClearButton.isVisible();
    }
    
    /* Her kommer generert kode for Button:MethodDeclaration*/
    
    /** Set enable/disable for button AnswerSaveButton 
     * @param b true for enabled, false for not 
     */
    public void setEnabledAnswerSaveButton(boolean b) {
        view.AnswerSaveButton.setEnabled(b);
    }
    
    /**
     * Shows or hides AnswerSaveButton depending on the parameter.
     * @param b <code>true</code> to show, <code>false</code> to hide.
     */
    public void setShownAnswerSaveButton(boolean b) {
        view.AnswerSaveButton.setVisible(b);
    }
    
    /**
     * Attemts to transfer input focus to AnswerSaveButton
     */
    public void setFocusAnswerSaveButton() {
        view.AnswerSaveButton.requestFocusInWindow();
    }
    
    /**
     * Check if AnswerSaveButton is enabled.
     * @return <code>true</code> if AnswerSaveButton is enabled.
     */
    public boolean isEnabledAnswerSaveButton() {
        return view.AnswerSaveButton.isEnabled();
    }
    
    /**
     * Check if AnswerSaveButton is the focus owner.
     * @return <code>true</code> if AnswerSaveButton is the focus owner.
     */
    public boolean hasFocusAnswerSaveButton() {
        return view.AnswerSaveButton.isFocusOwner();
    }
    
    /**
     * Check if AnswerSaveButton is visible. Note that this does 
     * not imply that AnswerSaveButton is actually showing, only that it can be 
     * drawn on the screen.
     * @return <code>true</code> if AnswerSaveButton is visible.
     */
    public boolean isShownAnswerSaveButton() {
        return view.AnswerSaveButton.isVisible();
    }
    
    /* Her kommer generert kode for Button:MethodDeclaration*/
    
    /** Set enable/disable for button AnswerDeleteButton 
     * @param b true for enabled, false for not 
     */
    public void setEnabledAnswerDeleteButton(boolean b) {
        view.AnswerDeleteButton.setEnabled(b);
    }
    
    /**
     * Shows or hides AnswerDeleteButton depending on the parameter.
     * @param b <code>true</code> to show, <code>false</code> to hide.
     */
    public void setShownAnswerDeleteButton(boolean b) {
        view.AnswerDeleteButton.setVisible(b);
    }
    
    /**
     * Attemts to transfer input focus to AnswerDeleteButton
     */
    public void setFocusAnswerDeleteButton() {
        view.AnswerDeleteButton.requestFocusInWindow();
    }
    
    /**
     * Check if AnswerDeleteButton is enabled.
     * @return <code>true</code> if AnswerDeleteButton is enabled.
     */
    public boolean isEnabledAnswerDeleteButton() {
        return view.AnswerDeleteButton.isEnabled();
    }
    
    /**
     * Check if AnswerDeleteButton is the focus owner.
     * @return <code>true</code> if AnswerDeleteButton is the focus owner.
     */
    public boolean hasFocusAnswerDeleteButton() {
        return view.AnswerDeleteButton.isFocusOwner();
    }
    
    /**
     * Check if AnswerDeleteButton is visible. Note that this does 
     * not imply that AnswerDeleteButton is actually showing, only that it can be 
     * drawn on the screen.
     * @return <code>true</code> if AnswerDeleteButton is visible.
     */
    public boolean isShownAnswerDeleteButton() {
        return view.AnswerDeleteButton.isVisible();
    }
    /** 
     * Generated event-action method, invoked from the framework.
     * This method is normally invoked on the EDT, and creates invokes 
     * <code>closeAnswer()</code> asynchronous on a dedicated thread.
     * 
     *  <p><strong>Normally, developers should not invoke this method - use 
     * <code>closeAnswer()</code> instead.</strong>
     * 
     ...
     * GenovaException.
     */ 
    public void closeAnswer(final GenovaEventHolder e) throws RuntimeException { 
        Runnable task = new Runnable() {
                public void run() {
                    blockDialog();
                    boolean setLastEx = true;
                    try {
                        if (hookcloseAnswerBefore(e)) {
                            setLastEx = false;
                            closeAnswer();
                        } else {
                            setLastEx = false;
                        }
                        hookcloseAnswerAfter(e);
     ...
     * <code>closeAnswer(GenovaEventHolder)</code>. Override this
     ...
     * GenovaException.
     */ 
    public void closeAnswer() throws RuntimeException { 
            actionCloseAnswer(); 
    }
    /** 
     * Generated event-action method, invoked from the framework.
     * This method is normally invoked on the EDT, and creates invokes 
     * <code>clearAnswer()</code> asynchronous on a dedicated thread.
     * 
     *  <p><strong>Normally, developers should not invoke this method - use 
     * <code>clearAnswer()</code> instead.</strong>
     * 
     * <p>The dedicated thread is scheduled for execution by a Genova Worker
     * instance. The instance "belongs" to this dialog and will be created
     * if necessary. 
     ...
     * GenovaException.
     */ 
    public void clearAnswer(final GenovaEventHolder e) throws RuntimeException { 
        // Noe på server
        Runnable task = new Runnable() {
                public void run() {
                    blockDialog();
                    boolean setLastEx = true;
                    try {
                        if (hookclearAnswerBefore(e)) {
                            setLastEx = false;
                            clearAnswer();
                        } else {
                            setLastEx = false;
                        }
                        hookclearAnswerAfter(e);
                    } catch (RuntimeException ex) {
                        setLastEx = dialogExceptionHandler(ex) && setLastEx;
                        if (setLastEx) {
                            application.setLastException(ex);
    ...
    /** 
     * Standard method, performing various actions. Invoked from the
     * <code>clearAnswer(GenovaEventHolder)</code>. Override this
     * method if you want to performe some additional tasks. 
     *
     *
     * @exception RuntimeException Thrown exceptions are handled if of type
     * GenovaException.
     */ 
    public void clearAnswer() throws RuntimeException { 
            actionClearAnswer(); 
    }
    /** 
     * Generated event-action method, invoked from the framework.
     * This method is normally invoked on the EDT, and creates invokes 
     * <code>saveAnswer()</code> asynchronous on a dedicated thread.
     * 
     *  <p><strong>Normally, developers should not invoke this method - use 
     * <code>saveAnswer()</code> instead.</strong>
     * 
     * <p>The dedicated thread is scheduled for execution by a Genova Worker
     * instance. The instance "belongs" to this dialog and will be created
     * if necessary. 
     ...
     * GenovaException.
     */ 
    public void saveAnswer(final GenovaEventHolder e) throws RuntimeException { 
        // Noe på server
        Runnable task = new Runnable() {
                public void run() {
                    blockDialog();
                    boolean setLastEx = true;
                    try {
                        if (hooksaveAnswerBefore(e)) {
                            setLastEx = false;
                            saveAnswer();
                        } else {
                            setLastEx = false;
                        }
                        hooksaveAnswerAfter(e);
                    } catch (RuntimeException ex) {
                        setLastEx = dialogExceptionHandler(ex) && setLastEx;
                        if (setLastEx) {
                            application.setLastException(ex);
    ...
    /** 
     * Standard method, performing various actions. Invoked from the
     * <code>saveAnswer(GenovaEventHolder)</code>. Override this
     * method if you want to performe some additional tasks. 
     *
     *
     * @exception RuntimeException Thrown exceptions are handled if of type
     * GenovaException.
     */ 
    public void saveAnswer() throws RuntimeException { 
            actionSaveAnswer(); 
    }
    /** 
     * Generated event-action method, invoked from the framework.
     * This method is normally invoked on the EDT, and creates invokes 
     * <code>deleteAnswer()</code> asynchronous on a dedicated thread.
     * 
     *  <p><strong>Normally, developers should not invoke this method - use 
     * <code>deleteAnswer()</code> instead.</strong>
     * 
     * <p>The dedicated thread is scheduled for execution by a Genova Worker
     * instance. The instance "belongs" to this dialog and will be created
     * if necessary. 
     ...
     * GenovaException.
     */ 
    public void deleteAnswer(final GenovaEventHolder e) throws RuntimeException { 
        // Noe på server
        Runnable task = new Runnable() {
                public void run() {
                    blockDialog();
                    boolean setLastEx = true;
                    try {
                        if (hookdeleteAnswerBefore(e)) {
                            setLastEx = false;
                            deleteAnswer();
                        } else {
                            setLastEx = false;
                        }
                        hookdeleteAnswerAfter(e);
                    } catch (RuntimeException ex) {
                        setLastEx = dialogExceptionHandler(ex) && setLastEx;
                        if (setLastEx) {
                            application.setLastException(ex);
    ...
    /** 
     * Standard method, performing various actions. Invoked from the
     * <code>deleteAnswer(GenovaEventHolder)</code>. Override this
     * method if you want to performe some additional tasks. 
     *
     *
     * @exception RuntimeException Thrown exceptions are handled if of type
     * GenovaException.
     */ 
    public void deleteAnswer() throws RuntimeException { 
            actionDeleteAnswer(); 
    }
     ...
     */
    public boolean hookActionCloseAnswerException(RuntimeException e) {
        return true;
    }
    /**
     * Hook method, called if the action resulted in a RuntimeException. 
     ...
     * @return <code>false</code> the hook has handeled the exception, and no further action is needed.
     */
    public boolean hookActionClearAnswerException(RuntimeException e) {
        return true;
    }         
     ...
     * <code>actionSaveAnswer()</code> method.
     ...
     */
    public boolean hookActionSaveAnswerException(RuntimeException e) {
        return true;
    }
     ...
     */
    public boolean hookActionSaveAnswerObtain(ObjectSelection objectSelection) {
        return true;
    }
     ...
     */
    public ClientContext hookActionSaveAnswerClientContext() {
        return null;
    }


    /**
     * Hook method, called before the found object in saveAnswer is 
     * displayed. The boolean return value is used to determine if the foundObject
     * should be displayed (defaults to <code>true</code>.
     * <p>Override in subclass! 
     * @param foundObject the object returned from the server action find on target Answer
     * @return <code>true</code> if the object should be displayed.
     */
    public boolean hookActionSaveAnswerDisplay(Object foundObject) {
        return true;
    }
     ...
     * <code>false</code>. If the hook returns <code>true</code> the 
     * exception will be re-thrown from the invoking 
     * <code>actionDeleteAnswer()</code> method.
     * <br>The default return value is <code>true</code>.
     * @param e the catched exception 
     * @return <code>false</code> if exception is handeled, 
     *         <code>true</code> if exception should be re-thrown.
     */
    public boolean hookActionDeleteAnswerException(RuntimeException e) {
        return true;
    }
     ...
     * @return <code>true</code> if action should proceed.
     */
    public boolean hookActionDeleteAnswerObtain(ObjectSelection objectSelection) {
        return true;
    }
     ...
     * @return the ClientContext that will be used as argument to the server action.
     */
    public ClientContext hookActionDeleteAnswerClientContext() {
        return null;
    }


    /**
     * Hook method, called before the found object in deleteAnswer is 
     * displayed. The boolean return value is used to determine if the foundObject
     * should be displayed (defaults to <code>true</code>.
     * <p>Override in subclass! 
     * @param foundObject the object returned from the server action find on target Answer
     * @return <code>true</code> if the object should be displayed.
     */
    public boolean hookActionDeleteAnswerDisplay(Object foundObject) {
        return true;
    }


    /**
     * Hook method, invoked as part of "checkSave" on Answer.
     * Override in subclass! 
     * <p>The return value must be one of the following:
     *
     * <ul>
     *   <li><code>ECheckResult.DEFAULT</code> - continue with check
     *   <li><code>ECheckResult.UNCHANGED</code> - Answer and children 
     *       are unchanged
     *   <li><code>ECheckResult.CONTINUE</code> - Answer is unchanged, 
     *       check children
     *   <li><code>ECheckResult.CHANGED</code> - Answer is changed
     * </ul>
     *
     ...
     */
     public ECheckResult hookAnswerCheckSave() {
        return hookCheckSaveAnswer() ? 
     ...
     * hookAnswerCheckSave instead.</strong>
     * Hook method, called as part of "check save" on 
     * Answer. Override in subclass!
     ...
     * @see #hookAnswerCheckSave()
     */
    public boolean hookCheckSaveAnswer() {
        return true;
    }


    /**
     * Hook method, invoked as part of "checkFind" on Answer.
     * Override in subclass! 
     * <p>The return value must be one of the following:
     *
     * <ul>
     ...
     * @return an ECheckResult 
     */
     public ECheckResult hookAnswerCheckFind() {
        return hookCheckFindAnswer() ? 
                ECheckResult.DEFAULT : ECheckResult.UNCHANGED;
     }
    ...
    /**
     * <strong>The use of this method is discouraged. Override
     * hookAnswerCheckFind instead.</strong>
     * Hook method, called as part of "check find" on Answer. Override in subclass!
     * The return value have the following semantics:
     * <ul>
     ...
     * @see #hookAnswerCheckFind()
     */
    public boolean hookCheckFindAnswer() {
        return true;
    }


    /**
     * Hook method, invoked as part of "checkClose" on Answer.
     * Override in subclass! 
     * <p>The return value must be one of the following:
     *
     * <ul>
     ...
     * @return an ECheckResult 
     */
     public ECheckResult hookAnswerCheckClose() {
        return hookCheckCloseAnswer() ? 
                ECheckResult.DEFAULT : ECheckResult.UNCHANGED;
     }
    ...
    /**
     * <strong>The use of this method is discouraged. Override
     * hookAnswerCheckClose instead.</strong>
     * Hook method, called as part of "check close" on Answer. Override in subclass!
     * The return value have the following semantics:
     * <ul>
     ...
     * @see #hookAnswerCheckClose()
     */
    public boolean hookCheckCloseAnswer() {
        return true;
    }


    /**
     * Hook method, invoked as part of "checkDelete" on Answer.
     * Override in subclass! 
     * <p>The return value must be one of the following:
     *
     * <ul>
     ...
     * @return an ECheckResult 
     */
     public ECheckResult hookAnswerCheckDelete() {
        return hookCheckDeleteAnswer() ? 
                ECheckResult.DEFAULT : ECheckResult.UNCHANGED;
     }
    ...
    /**
     * <strong>The use of this method is discouraged. Override
     * hookAnswerCheckDelete instead.</strong>
     * Hook method, called as part of "check delete" on Answer. Override in subclass!
     * The return value have the following semantics:
     * <ul>
     ...
     * @see #hookAnswerCheckDelete()
     */
    public boolean hookCheckDeleteAnswer() {
        return true;
    }


    /**
     * Hook method, invoked as part of "checkPrint" on Answer.
     * Override in subclass! 
     * <p>The return value must be one of the following:
     *
     * <ul>
     ...
     * @return an ECheckResult 
     */
     public ECheckResult hookAnswerCheckPrint() {
        return hookCheckPrintAnswer() ? 
                ECheckResult.DEFAULT : ECheckResult.UNCHANGED;
     }
    ...
    /**
     * <strong>The use of this method is discouraged. Override
     * hookAnswerCheckPrint instead.</strong>
     * Hook method, called as part of "check print" on Answer. Override in subclass!
     * The return value have the following semantics:
     * <ul>
     ...
     * @see #hookAnswerCheckPrint()
     */
    public boolean hookCheckPrintAnswer() {
        return true;
    }


    /**
     * Hook method, invoked as part of "checkClear" on Answer.
     * Override in subclass! 
     * <p>The return value must be one of the following:
     *
     * <ul>
     ...
     * @return an ECheckResult 
     */
     public ECheckResult hookAnswerCheckClear() {
        return hookCheckClearAnswer() ? 
                ECheckResult.DEFAULT : ECheckResult.UNCHANGED;
     }
    ...
    /**
     * <strong>The use of this method is discouraged. Override
     * hookAnswerCheckClear instead.</strong>
     * Hook method, called as part of "check clear" on Answer. Override in subclass!
     * The return value have the following semantics:
     * <ul>
     ...
     * @see #hookAnswerCheckClear()
     */
    public boolean hookCheckClearAnswer() {
        return true;
    }


    /**
     * Hook method, invoked as part of "checkChange" on Answer.
     * Override in subclass! 
     * <p>The return value must be one of the following:
     *
     * <ul>
     ...
     * @return an ECheckResult 
     */
     public ECheckResult hookAnswerCheckChange() {
        return hookCheckChangeAnswer() ? 
                ECheckResult.DEFAULT : ECheckResult.UNCHANGED;
     }
    ...
    /**
     * <strong>The use of this method is discouraged. Override
     * hookAnswerCheckChange instead.</strong>
     * Hook method, called as part of "check change" on Answer. Override in subclass!
     * The return value have the following semantics:
     * <ul>
     ...
     * @see #hookAnswerCheckChange()
     */
    public boolean hookCheckChangeAnswer() {
        return true;
    }
    /**
     * Hook method, invoked as part of "check row select" on Answer.
     * Override in subclass! 
     * <p>The return value must be one of the following:
     *
     * <ul>
     ...
     */
     public ECheckResult hookAnswerCheckRowSelect
                (int oldSelection, int newSelection) {
        return hookCheckRowSelectAnswer(oldSelection, newSelection) ? 
                ECheckResult.DEFAULT : ECheckResult.UNCHANGED;
     }
    ...
    /** 
     * <strong>The use of this method is discouraged. Override
     * hookAnswerCheckRowSelect instead.</strong>
     * Hook method, called as part of "check row selection" on Answer. Override in subclass!
     * The return value have the following semantics:
     * <ul>
     ...
     *         <code>false</code> if check change should finish cheking and
     *         continue with change action.
     * @see #hookAnswerCheckRowSelect(int, int)
     */
    public boolean hookCheckRowSelectAnswer(int currentSelection, 
            int newSelection) {
        return true;
    }
     ...
     */
    public boolean hookcloseAnswerBefore(GenovaEventHolder e) {
        return true;
    }
    /**
     * 
     ...
     * @param e the event that triggered this method.
     */
    public void hookcloseAnswerAfter(GenovaEventHolder e) {
     ...
     * @return true if the rest of the actions are to be execuded.
     */
    public boolean hookclearAnswerBefore(GenovaEventHolder e) {
        return true;
    }
    /**
     * 
     ...
     * @param e the event that triggered this method.
     */
    public void hookclearAnswerAfter(GenovaEventHolder e) {
        // empty method overridden in subclass
    }
    /**
     * Hook method. Override in subclass.
     ...
     * @return true if the rest of the actions are to be execuded.
     */
    public boolean hooksaveAnswerBefore(GenovaEventHolder e) {
        return true;
    }
    /**
     * 
     ...
     * @param e the event that triggered this method.
     */
    public void hooksaveAnswerAfter(GenovaEventHolder e) {
        // empty method overridden in subclass
    }
    /**
     * Hook method. Override in subclass.
     ...
     * @return true if the rest of the actions are to be execuded.
     */
    public boolean hookdeleteAnswerBefore(GenovaEventHolder e) {
        return true;
    }
    /**
     * 
     ...
     * @param e the event that triggered this method.
     */
    public void hookdeleteAnswerAfter(GenovaEventHolder e) {
        // empty method overridden in subclass
    }
...
//               Class toClass = to.getClass();
    ...
    /**
     * Hook method, invoked after the obtaining the Answer object.
     * The returned Answer object is the object that will be used as
     ...
     */
    public Answer hookAfterObtainAnswer(Answer domainObject) {
        // override in subclass!
        return domainObject;
    }
    ...
    /**
     * Invokes check close on the Answer dialog, and closes the
     * Answer dialog if checkClose returned <code>true</code>
     */
    protected void actionCloseAnswer() {
        ...
        try {
            SwingUtilities.invokeAndWait(new Runnable() {
                public void run() {
                    ...
                    try {
                        ...
                        if (hookActionCloseAnswerException(e)) {
                            throw e;
                        }
            ...
            if (msgID != null) {
               Object[] msgArgs = {this.getClass(), "actionCloseAnswer", ex};
               Message msg = MessageSystem.getMessageFactory().getMessage(msgID, msgArgs);
               MessageSystem.getMessageDispatcher(MessageSystem.NO_INTERACTION).dispatch(msg);
               throw new GenovaClientFrameworkException(ex, msg);
            }
    ...
    /**
     * Recursivly clears all fields in the Answer 
     * object selection node, and
     * sets the cleared nodes' state to CLEARED.
     */
    protected void actionClearAnswer() {
        String msgID = null;
        Exception ex = null;
        ...
        try {
            SwingUtilities.invokeAndWait(new Runnable() {
                public void run() {
                    try {
                        if (theAnswer.checkClear()) {
                            new ClearTool(roleObjects).clearRole("Answer");
                            theAnswer.nullProxy();
                        }
                    } catch (RuntimeException e) {
                        if (hookActionClearAnswerException(e)) {
                            throw e;
                        }
                    }
                }
            ...
            if (msgID != null) {
               Object[] msgArgs = {this.getClass(), "actionClearAnswer", ex};
               Message msg = MessageSystem.getMessageFactory().getMessage(msgID, msgArgs);
               MessageSystem.getMessageDispatcher(MessageSystem.NO_INTERACTION).dispatch(msg);
               throw new GenovaClientFrameworkException(ex, msg);
            }
    ...
    /**
     * The Save Answer JGrape action. This action involves 
     * the following steps.
     * <ol>
     *  <li>The Answer's check method for Save is invoked, possibly
     *      aborting the action.
     * 
     ...
     *     target, the hookActionSaveAnswerObtain(ObjectSelection)
     *     method is invoked, possibly aborting the action.
     *
     * <li>Next, hookActionSaveAnswerClientContext() is invoked. 
     ...
     *
     * <li>Invoke hookActionSaveAnswerDisplay(resultObject), possibly 
     *     aborting the action.
     *
     * <li>Recursively clear the Answer node and the recursivly
     *     display the result.
     * </ol>
     */
    protected void actionSaveAnswer() {
        try {

            if (!theAnswer.checkSave()) {
                Message msg = MessageSystem.getMessageFactory().getMessage(CRuntimeMsg.CF_ABORTING_ACTION, "checkSave", "save", "Answer");
                MessageSystem.getMessageDispatcher(MessageSystem.NO_INTERACTION).dispatch(msg);
                return;
            }

            Message msg = MessageSystem.getMessageFactory().getMessage(CRuntimeMsg.CF_CONTINUING_ACTION, "save", "Answer");
            MessageSystem.getMessageDispatcher(MessageSystem.NO_INTERACTION).dispatch(msg);

            List selectedLines = getListblockStates(theAnswer.getPathToNode());
            ObjectSelection os = obtainObjectSelection(theAnswer);
            os.setTargetMainKey(theAnswer.getTargetMainKey());

            boolean goAhead = false;
            try {
                goAhead = hookActionSaveAnswerObtain(os);
            } catch (RuntimeException e) { 
                goAhead = false;
                throw e;
            } finally {
                if (!goAhead) {
                    ...
                    Object parent = os.getRootObject(theAnswer
                            .getRootNode().getRoleName());
                    if (parent != null) {
                        AbstractNode top = (AbstractNode) theAnswer
                                .getRootNode();
                        List pathToTarget = theAnswer.getPathToNode();
            ...
            ClientContext ctx = hookActionSaveAnswerClientContext();
            if (ctx == null) {
            ...
            if (resultObject != null) {
                AbstractNode top = (AbstractNode) theAnswer.getRootNode();
                List pathToTarget = theAnswer.getPathToNode();
            ...
            if (hookActionSaveAnswerDisplay(resultObject)) {
                new ClearTool(roleObjects).clearKeepKeys("Answer");
                resetProxy();
                if (resultObject != null) {
                    theAnswer.getRootNode().displayOnEDT(resultObject, theAnswer.getPathToNode(), false);
                } 
            ...
            if (hookActionSaveAnswerException(e)) {
                throw e;
            }
        } 
    }
    ...
    /**
     * The Delete Answer JGrape action. This action involves 
     * the following steps.
     * <ol>
     *  <li>The Answer's check method for Delete is invoked, possibly
     *      aborting the action.
     * 
     * <li>After a recursive obtain, which builds up a minimum tree
     *     containing only the objects needed by the server to identify the
     *     target, the hookActionDeleteAnswerObtain(ObjectSelection)
     *     method is invoked, possibly aborting the action.
     *
     * <li>Next, hookActionDeleteAnswerClientContext() is invoked. 
     *     If the method returns <code>null</code> a default client 
     *     context is used.
     *
     * <li>The object selection and the client context is used as arguments
     ...
     *     where stripped away when performing the recursive obtain.
     *
     * <li>Invoke hookActionDeleteAnswerDisplay(resultObject), possibly 
     *     aborting the action.
     *
     * <li>Recursively clear the Answer node and the recursivly
     *     display the result.
     * </ol>
     */
    protected void actionDeleteAnswer() {
        try {

            if (!theAnswer.checkDelete()) {
                Message msg = MessageSystem.getMessageFactory().getMessage(CRuntimeMsg.CF_ABORTING_ACTION, "checkDelete", "delete", "Answer");
                MessageSystem.getMessageDispatcher(MessageSystem.NO_INTERACTION).dispatch(msg);
                return;
            }

            Message msg = MessageSystem.getMessageFactory().getMessage(CRuntimeMsg.CF_CONTINUING_ACTION, "delete", "Answer");
            MessageSystem.getMessageDispatcher(MessageSystem.NO_INTERACTION).dispatch(msg);
            ...
            boolean goAhead = false;
            try {
                goAhead = hookActionDeleteAnswerObtain(os);
            } catch (RuntimeException e) { 
                goAhead = false;
                throw e;
            } finally {
            ...
            ClientContext ctx = hookActionDeleteAnswerClientContext();
            if (ctx == null) {
                ctx = Application.getClientContext();
            }
            ...
            Object root = os.getRootObject(theAnswer.getRootNode().getRoleName());
            theAnswer.removeFromParent(root);
            if (resultObject != null) {
                AbstractNode top = (AbstractNode) theAnswer.getRootNode();
                List pathToTarget = theAnswer.getPathToNode();
                if (resultObject.iterator().hasNext()) {
            ...
            if (hookActionDeleteAnswerDisplay(resultObject)) {
                new ClearTool(roleObjects).clear("Answer");
                resetProxy();
                if (resultObject != null) {
                    theAnswer.getRootNode().displayOnEDT(resultObject, theAnswer.getPathToNode(), false);
                } 
            ...
            if (hookActionDeleteAnswerException(e)) {
                throw e;
            }
        } 
    }
