...
public class CourseAppController extends CourseAppDefaultController {
    ...
    @Override
    protected CourseAppDefaultView hookInstantiateView(CourseAppDefaultController controller, GenovaEnums applicationEnums) {
        return new CourseAppView(controller, applicationEnums);
    }
}
