...
public class AssignmentController extends AssignmentDefaultController {
    ...
    @Override
    protected AssignmentDefaultView hookInstantiateView(AssignmentDefaultController controller, GenovaEnums applicationEnums) {
        return new AssignmentView(controller, applicationEnums);
    }
}
