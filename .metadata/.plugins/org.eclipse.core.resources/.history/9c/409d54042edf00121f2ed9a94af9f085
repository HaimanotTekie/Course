 ...
 * Assignment. This class is generated and should not be edited
 * in. If any changes are needed, do them in AssignmentView.
 */ 
@SuppressWarnings("all")
public abstract class AssignmentDefaultView extends GenovaDialogFrame implements BottomWindow {
    ...
    JInternalFrame theAssignmentInternalFrame = this;
    ...
    /** The AssignmentClass simple block */
    protected JPanel AssignmentClass = new JPanel();
    
    /** The AssignmentData simple block */
    protected JPanel AssignmentData = new JPanel();
    
    /** The AssignmentAssignmentTextLabel label */
    protected JLabel AssignmentAssignmentTextLabelLabel = new JLabel("AssignmentText");
    GenovaTextField Assignment_assignmentText = new GenovaTextField("");
    final Object objectVersionOfAssignmentassignmentText = Assignment_assignmentText;
    String oldValueAssignmentassignmentText;
    
    /** The AssignmentButton simple block */
    protected JPanel AssignmentButton = new JPanel();
    
    /* Her kommer generert kode for Button:Declaration*/
    
    JButton AssignmentClearButton;
    
    
    /* Her kommer generert kode for Button:Declaration*/
    
    JButton AssignmentSaveButton;
    
    
    /* Her kommer generert kode for Button:Declaration*/
    
    JButton AssignmentDeleteButton;
   ...
   /**
     ...
     */
    public AssignmentDefaultView(final AssignmentDefaultController controller, GenovaEnums applicationEnums) {
    ...
    private void initNameComponentMappings() {
        nameToComponent.put("AssignmentClass", AssignmentClass);
        componentToName.put(AssignmentClass, "AssignmentClass");
        nameToComponent.put("AssignmentData", AssignmentData);
        componentToName.put(AssignmentData, "AssignmentData");
        nameToComponent.put("AssignmentAssignmentTextLabel", AssignmentAssignmentTextLabelLabel);
        componentToName.put(AssignmentAssignmentTextLabelLabel, "AssignmentAssignmentTextLabel");
        nameToComponent.put("Assignment.assignmentText", Assignment_assignmentText);
        componentToName.put(Assignment_assignmentText, "Assignment.assignmentText");
        nameToComponent.put("AssignmentButton", AssignmentButton);
        componentToName.put(AssignmentButton, "AssignmentButton");
        nameToComponent.put("AssignmentClearButton", AssignmentClearButton);
        componentToName.put(AssignmentClearButton, "AssignmentClearButton");
        nameToComponent.put("AssignmentSaveButton", AssignmentSaveButton);
        componentToName.put(AssignmentSaveButton, "AssignmentSaveButton");
        nameToComponent.put("AssignmentDeleteButton", AssignmentDeleteButton);
        componentToName.put(AssignmentDeleteButton, "AssignmentDeleteButton");
    }
    ...
    private void initWindow() {
        Window_outer.setPreferredSize(new Dimension(334, 144));
    ...
    /** Initializes the AssignmentClass container */
    private void initAssignmentClass() {
        Window.add(AssignmentClass);
        AssignmentClass.setLocation(11+0,11+0);
        AssignmentClass.setSize(312, 122);
        RepositoryProxy.setBorder(AssignmentClass,2,"Assignment");
        RepositoryProxy.setForegroundColor(AssignmentClass,"Black");
        RepositoryProxy.setFont(AssignmentClass,"Standard");
        AssignmentClass.setLayout(null);
        
        initAssignmentData();
        initAssignmentButton();
    }
    
    /** Initializes the AssignmentData container */
    private void initAssignmentData() {
        AssignmentClass.add(AssignmentData);
        AssignmentData.setLocation(14+3,17+10);
        AssignmentData.setSize(249, 22);
        RepositoryProxy.setBorder(AssignmentData,1,"Assignment");
        RepositoryProxy.setForegroundColor(AssignmentData,"Black");
        RepositoryProxy.setFont(AssignmentData,"Standard");
        AssignmentData.setLayout(null);
        
        initAssignmentAssignmentTextLabelLabel();
        initAssignment_assignmentText();
    }
    
    /** Initializes the AssignmentButton container */
    private void initAssignmentButton() {
        AssignmentClass.add(AssignmentButton);
        AssignmentButton.setLocation(274+3,17+10);
        AssignmentButton.setSize(24, 78);
        RepositoryProxy.setBorder(AssignmentButton,1,"Assignment");
        RepositoryProxy.setForegroundColor(AssignmentButton,"Black");
        RepositoryProxy.setFont(AssignmentButton,"Standard");
        AssignmentButton.setLayout(null);
        
        initAssignmentClearButton();
        initAssignmentSaveButton();
        initAssignmentDeleteButton();
    }
    /**
     * Initializes the AssignmentAssignmentTextLabel label */
    private void initAssignmentAssignmentTextLabelLabel() {
        AssignmentData.add(AssignmentAssignmentTextLabelLabel);
        AssignmentAssignmentTextLabelLabel.setLocation(0+0,0+0); 
        AssignmentAssignmentTextLabelLabel.setSize(92, 17);
        RepositoryProxy.setForegroundColor(AssignmentAssignmentTextLabelLabel,"Black");
        RepositoryProxy.setFont(AssignmentAssignmentTextLabelLabel,"Standard");
    }
    
    /** Initializes the Assignment.assignmentText text component */
    private void initAssignment_assignmentText() {
        Assignment_assignmentText.setName("Assignment.assignmentText");
        AssignmentData.add(Assignment_assignmentText);
        Assignment_assignmentText.setLocation(97+0,0+0);
        { // limit scope of width and height declarations.
            int width = 152;
            int height = 22;
            Assignment_assignmentText.setSize(width, height);
            if (width == 0 && height == 0) {
                Assignment_assignmentText.setFocusable(false);
            }
        } // end limit scope
        
        controller.tabListFromNodeNameAssignmentData.put("Assignment.assignmentText", Assignment_assignmentText);
        controller.tabListFromComponentAssignmentData.put(Assignment_assignmentText, "Assignment.assignmentText");
        
           //   Assignment_assignmentText.setEditable(true);
        Assignment_assignmentText.setEditable(true);
        
        //Assignment_assignmentText.setVisible(false || true);
        //
        Assignment_assignmentText.setInputJustification(JTextField.LEFT);
        Assignment_assignmentText.setOutputJustification(JTextField.LEFT);
        Assignment_assignmentText.setHorizontalAlignment(JTextField.LEFT);
        Assignment_assignmentText.setSelectAllOnFocus(true);
        RepositoryProxy.setDatatype(7, Assignment_assignmentText, 0, controller.getApplication().getEnums(), null, 
              FormatHelper.getDisplayrule(7,"",0,0,0),0,false);
        RepositoryProxy.setForegroundColor(Assignment_assignmentText,"Black");
        RepositoryProxy.setFont(Assignment_assignmentText,"Standard");
        
        // No Listener
        
    }
    
    /** Initializes the AssignmentClearButton button */
    private void initAssignmentClearButton() {
        
        /* Her kommer generert kode for Button:Setup*/
        
        ImageIcon imageAssignmentClearButton = null;
        imageAssignmentClearButton = RepositoryProxy.getImageField("Clear");
        if (imageAssignmentClearButton != null) {
            AssignmentClearButton = new GenovaButton(imageAssignmentClearButton);
        }
        else {
            AssignmentClearButton = new GenovaButton("Clear");
        }
        AssignmentButton.add(AssignmentClearButton);
        AssignmentClearButton.setLocation(0+0,0+0);
        AssignmentClearButton.setSize(24, 22);
        AssignmentClearButton.setMargin(new Insets(0,0,0,0));
        RepositoryProxy.setForegroundColor(AssignmentClearButton,"Black");
        RepositoryProxy.setFont(AssignmentClearButton,"Standard");
        RepositoryProxy.setImage(AssignmentClearButton,"Clear");
        AssignmentClearButton.addActionListener(actionProc);
        
        controller.tabListFromNodeNameAssignmentButton.put("AssignmentClearButton", AssignmentClearButton);
        controller.tabListFromComponentAssignmentButton.put(AssignmentClearButton, "AssignmentClearButton");
    }
    
    /** Initializes the AssignmentSaveButton button */
    private void initAssignmentSaveButton() {
        
        /* Her kommer generert kode for Button:Setup*/
        
        ImageIcon imageAssignmentSaveButton = null;
        imageAssignmentSaveButton = RepositoryProxy.getImageField("Save");
        if (imageAssignmentSaveButton != null) {
            AssignmentSaveButton = new GenovaButton(imageAssignmentSaveButton);
        }
        else {
            AssignmentSaveButton = new GenovaButton("Save");
        }
        AssignmentButton.add(AssignmentSaveButton);
        AssignmentSaveButton.setLocation(0+0,28+0);
        AssignmentSaveButton.setSize(24, 22);
        AssignmentSaveButton.setMargin(new Insets(0,0,0,0));
        RepositoryProxy.setForegroundColor(AssignmentSaveButton,"Black");
        RepositoryProxy.setFont(AssignmentSaveButton,"Standard");
        RepositoryProxy.setImage(AssignmentSaveButton,"Save");
        AssignmentSaveButton.addActionListener(actionProc);
        
        controller.tabListFromNodeNameAssignmentButton.put("AssignmentSaveButton", AssignmentSaveButton);
        controller.tabListFromComponentAssignmentButton.put(AssignmentSaveButton, "AssignmentSaveButton");
    }
    
    /** Initializes the AssignmentDeleteButton button */
    private void initAssignmentDeleteButton() {
        
        /* Her kommer generert kode for Button:Setup*/
        
        ImageIcon imageAssignmentDeleteButton = null;
        imageAssignmentDeleteButton = RepositoryProxy.getImageField("Delete");
        if (imageAssignmentDeleteButton != null) {
            AssignmentDeleteButton = new GenovaButton(imageAssignmentDeleteButton);
        }
        else {
            AssignmentDeleteButton = new GenovaButton("Delete");
        }
        AssignmentButton.add(AssignmentDeleteButton);
        AssignmentDeleteButton.setLocation(0+0,56+0);
        AssignmentDeleteButton.setSize(24, 22);
        AssignmentDeleteButton.setMargin(new Insets(0,0,0,0));
        RepositoryProxy.setForegroundColor(AssignmentDeleteButton,"Black");
        RepositoryProxy.setFont(AssignmentDeleteButton,"Standard");
        RepositoryProxy.setImage(AssignmentDeleteButton,"Delete");
        AssignmentDeleteButton.addActionListener(actionProc);
        
        controller.tabListFromNodeNameAssignmentButton.put("AssignmentDeleteButton", AssignmentDeleteButton);
        controller.tabListFromComponentAssignmentButton.put(AssignmentDeleteButton, "AssignmentDeleteButton");
    }
    /**
     * Internal code.
     */
    ...
    public void clearWindow() {
        clearAssignmentClass(); 
    }

    /**
     * Clears the AssignmentClass 
     */
    public void clearAssignmentClass() {
        clearAssignmentData(); 
        clearAssignmentButton(); 
    }

    /**
     * Clears the AssignmentData 
     */
    public void clearAssignmentData() {
        Assignment_assignmentText.setInitialValue(null);
        Assignment_assignmentText.setValue(null);
    }

    /**
     * Clears the AssignmentButton 
     */
    public void clearAssignmentButton() {
    }
        ...
        class ActionProc implements ActionListener {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    if (e.getSource() == AssignmentClearButton) {
                        controller.clearAssignment(new GenovaActionEventHolder(e));
                    }
                    
                    /* Her kommer generert kode for Button ActionPerformed*/
                    
                    if (e.getSource() == AssignmentSaveButton) {
                        controller.saveAssignment(new GenovaActionEventHolder(e));
                    }
                    
                    /* Her kommer generert kode for Button ActionPerformed*/
                    
                    if (e.getSource() == AssignmentDeleteButton) {
                        controller.deleteAssignment(new GenovaActionEventHolder(e));
                    }
    /* Might be generated empty */
                }catch(Throwable t) {
                    e.getClass();
    ...
    /* Might be generated empty */
        ...
        if (blockWindowEventsWindow == 0) {
            ...
            controller.closeAssignment(new GenovaWindowEventHolder(e));
            blockWindowEventsWindow--;
        }
    /* Might be generated empty */
            }catch(Throwable t) {
