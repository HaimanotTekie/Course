...
public class Student_applRepository implements GenovaRepository {
    ...
    /** Default constructor */
    public Student_applRepository() {
        colors.put("Black", new Color(0,0,0));
        fonts.put("Standard", new Font("Tahoma", Font.PLAIN, FontTools.calcFontSize(8)));
        images.put("Clear", new ImageProxy("newSmall.bmp"));
        images.put("Delete", new ImageProxy("deleteSmall.bmp"));
        images.put("Save", new ImageProxy("saveSmall.bmp"));
