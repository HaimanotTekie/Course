...
public class AddStudentsToCourse_applEnums implements GenovaEnums {
   ...
   public void enumAssign(Object owner, String attribute, 
        ...
        try {
            ...
            if (ex != null) {
                Object[] msgArgs = {AddStudentsToCourse_applEnums.class, attribute, ownerClass, ex.getMessage()};
