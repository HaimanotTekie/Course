...
/**
 * The <code>Course2DefaultManager</code> class is generated by the Genova Service Generator from the object selection <code>Course_os</code>.
 * <p>
 * The java file containing this class should not be altered. All changes will be lost when the class is regenerated.
 * <p>
 * The class contains all methods used to manipulate the object selection role <code>Course2</code>
 * <p>
 * The role Course2 data objects are of class <code>no.course.domain.Course</code>;
 * <p>
 * <code>Course2</code> is a root role.
 * <p>
 * The <code>Course2</code> is a leaf role in the object selection <code>Course_os</code>
 * <p>
...
abstract public class Course2DefaultManager extends Role {
    ...
    */
    ...
    /**
     * Hook method called at start of <code>cleanupResultAsTarget</code> for role <code>Course2</code>.
     * <p>
    ...
    /**
     * Hook method called at end of <code>cleanupResultAsTarget</code> for role <code>Course2</code>.
     *
    ...
    /**
     * Hook method called at start of <code>find</code> for role <code>Course2</code>.
     * <p>
     * When overriding this hook has three possible exits:
     * <ul>
    ...
    /**
     * Hook method called at end of <code>find</code> for <code>Course2</code>.
     * <p>
     *
    ...
    /**
     * Hook method called at start of <code>findAll</code> for role <code>Course2</code>.
     * <p>
     * When overriding this hook has three possible exits:
     * <ul>
    ...
    /**
     * Hook method called at end of <code>findAll</code> for <code>Course2</code>
     * <p>
     *
    ...
    /**
     * Hook method called at start of <code>save</code> for role <code>Course2</code>.
     * <p>
     * When overriding this hook has three possible exits:
     * <ul>
    ...
    /**
     * Hook method called at end of <code>save</code> for <code>Course2</code>.
     *
     * @param objectSelection The <code>ObjectSelection</code> with data from the database.
    ...
    /**
     * Hook method called at start of <code>insert</code> for role <code>Course2</code>.
     * <p>
     * When overriding this hook has three possible exits:
     * <ul>
    ...
    /**
     * Hook method called at end of <code>insert</code> for <code>Course2</code>.
     * <p>
     *
     * @param objectSelection The <code>ObjectSelection</code> with data from the database.
    ...
    /**
     * Hook method called at start of <code>update</code> for role <code>Course2</code>.
     * <p>
     * When overriding this hook has three possible exits:
     * <ul>
    ...
    /**
     * Hook method called at end of <code>update</code> for <code>Course2</code>.
     * <p>
     *
     * @param objectSelection The <code>ObjectSelection</code> with data from the database.
     * @param resultObject The <code>Course</code> object that was updated.
    ...
    /**
     * Hook method called at start of <code>delete</code> for role <code>Course2</code>.
     * <p>
     * When overriding this hook has three possible exits:
     * <ul>
    ...
    /**
     * Hook method called at end of <code>delete</code> for <code>Course2</code>.
     * <p>
     *
     * @param objectSelection The <code>ObjectSelection</code> with data from the database.
     ...
     * @return The <code>Course2</code> object
     */
    final Object findRootObject(ObjectSelection objectSelection) {
        Object rootObject = null;
        if (objectSelection != null) {
            if (objectSelection.getCurrentRootName().equals("Course2")) {
                Collection roots = objectSelection.getRootObjects("Course2");
                if (roots != null) {
    ...
    final Object findTargetObject(ObjectSelection objectSelection) {
        ...
        if (objectSelection != null) {
            if (objectSelection.getCurrentRootName().equals("Course2")) {
                resultObject = objectSelection.getRootObjects("Course2");
                if (!(objectSelection.getTargetRoleName().equals("Course2")) && resultObject != null) {
     ...
     *
     * @param objectSelection The <code>ObjectSelection></code> to search
     * @return <code>Course2</code> is a root role. The method always return null.
     */
    ...
    final void changeRootObject(ObjectSelection objectSelection, Course oldRoot, Course newRoot) {
        if (objectSelection != null) {
            Collection collection = objectSelection.getRootObjects("Course2");
            if (collection != null) {
    ...
    public Course insertSingle(Course targetObject, String targetKey, FindData findData, ClientContext ctx, Session session) {
        ...
        if (!isIdentical(targetObject,resultObject)) {
            ...
            TriggerInvoker.invoke(resultObject,TriggerType.INSERT, getCurrentObjectSelection().getTargetRoleName().equals("Course2"), ctx, session);
    ...
    public Course updateSingle(Course targetObject, String targetKey, FindData findData, ClientContext ctx, Session session) {
        ...
        if (resultObject == null) {
            ...
            if (resultObject != null) {
                ...
                TriggerInvoker.invoke(resultObject,TriggerType.UPDATE, getCurrentObjectSelection().getTargetRoleName().equals("Course2"), ctx, session);
            }
            else {
                Object[] args = { "Course", "Course_os" };
    ...
    public void deleteSingle(Course object,ClientContext ctx,Session session) {
        if (hookDeleteSingleStart(object,ctx,session)) {
            ...
            TriggerInvoker.invoke(object,TriggerType.DELETE, getCurrentObjectSelection().getTargetRoleName().equals("Course2"), ctx, session);
        }
