...
/**
 * The <code>AddStudentsToCourse_osOsManager</code> class was generated by the Genova Service Generator from the object selection <code>AddStudentsToCourse_os</code>.
 * <p>
...
public class AddStudentsToCourse_osOsManager extends OsManager {
    ...
    public static String getStaticName() { 
        return "AddStudentsToCourse_osOsManager"; 
    } 
    ...
    public static Role newRoleManager(String applicationName, String roleName) {
        ...
        String fullName = OsManager.createManagerClassName(roleName,"no.course.service.application.office.addstudentstocourse_os");
        try {
    ...
    public Role newManager(String applicationName, String roleName) {
        return AddStudentsToCourse_osOsManager.newRoleManager(applicationName,roleName);
    }
