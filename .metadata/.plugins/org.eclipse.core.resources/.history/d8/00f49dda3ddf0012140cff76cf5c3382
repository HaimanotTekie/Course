...
package no.course.service.application.office.assignment_os.generated;
...
/**
 * The <code>AssignmentDefaultManager</code> class is generated by the Genova Service Generator from the object selection <code>Assignment_os</code>.
 * <p>
 * The java file containing this class should not be altered. All changes will be lost when the class is regenerated.
 * <p>
 * The class contains all methods used to manipulate the object selection role <code>Assignment</code>
 * <p>
 * The role Assignment data objects are of class <code>no.course.domain.Assignment</code>;
 * <p>
 * <code>Assignment</code> is a root role.
 * <p>
 * The <code>Assignment</code> is a leaf role in the object selection <code>Assignment_os</code>
 * <p>
...
abstract public class AssignmentDefaultManager extends Role {
    ...
    */
    ...
    /**
     * Hook method called at start of <code>cleanupResultAsTarget</code> for role <code>Assignment</code>.
     * <p>
    ...
    /**
     * Hook method called at end of <code>cleanupResultAsTarget</code> for role <code>Assignment</code>.
     *
    ...
    /**
     * Hook method called at start of <code>find</code> for role <code>Assignment</code>.
     * <p>
     * When overriding this hook has three possible exits:
     * <ul>
    ...
    /**
     * Hook method called at end of <code>find</code> for <code>Assignment</code>.
     * <p>
     *
    ...
    /**
     * Hook method called at start of <code>findAll</code> for role <code>Assignment</code>.
     * <p>
     * When overriding this hook has three possible exits:
     * <ul>
    ...
    /**
     * Hook method called at end of <code>findAll</code> for <code>Assignment</code>
     * <p>
     *
    ...
    /**
     * Hook method called at start of <code>save</code> for role <code>Assignment</code>.
     * <p>
     * When overriding this hook has three possible exits:
     * <ul>
    ...
    /**
     * Hook method called at end of <code>save</code> for <code>Assignment</code>.
     *
     * @param objectSelection The <code>ObjectSelection</code> with data from the database.
    ...
    /**
     * Hook method called at start of <code>insert</code> for role <code>Assignment</code>.
     * <p>
     * When overriding this hook has three possible exits:
     * <ul>
    ...
    /**
     * Hook method called at end of <code>insert</code> for <code>Assignment</code>.
     * <p>
     *
     * @param objectSelection The <code>ObjectSelection</code> with data from the database.
    ...
    /**
     * Hook method called at start of <code>update</code> for role <code>Assignment</code>.
     * <p>
     * When overriding this hook has three possible exits:
     * <ul>
    ...
    /**
     * Hook method called at end of <code>update</code> for <code>Assignment</code>.
     * <p>
     *
     * @param objectSelection The <code>ObjectSelection</code> with data from the database.
     * @param resultObject The <code>Assignment</code> object that was updated.
    ...
    /**
     * Hook method called at start of <code>delete</code> for role <code>Assignment</code>.
     * <p>
     * When overriding this hook has three possible exits:
     * <ul>
    ...
    /**
     * Hook method called at end of <code>delete</code> for <code>Assignment</code>.
     * <p>
     *
     * @param objectSelection The <code>ObjectSelection</code> with data from the database.
     ...
     * @return The <code>Assignment</code> object
     */
    final Object findRootObject(ObjectSelection objectSelection) {
        Object rootObject = null;
        if (objectSelection != null) {
            if (objectSelection.getCurrentRootName().equals("Assignment")) {
                Collection roots = objectSelection.getRootObjects("Assignment");
                if (roots != null) {
    ...
    final Object findTargetObject(ObjectSelection objectSelection) {
        ...
        if (objectSelection != null) {
            if (objectSelection.getCurrentRootName().equals("Assignment")) {
                resultObject = objectSelection.getRootObjects("Assignment");
                if (!(objectSelection.getTargetRoleName().equals("Assignment")) && resultObject != null) {
     ...
     *
     * @param objectSelection The <code>ObjectSelection></code> to search
     * @return <code>Assignment</code> is a root role. The method always return null.
     */
     ...
     * @param oldRoot The object <code>Assignment</code> to remove as root.
     * @param newRoot The object <code>Assignment</code> to insert as new  root.
     */
    final void changeRootObject(ObjectSelection objectSelection, Assignment oldRoot, Assignment newRoot) {
        if (objectSelection != null) {
            Collection collection = objectSelection.getRootObjects("Assignment");
            if (collection != null) {
     ...
     * the method will use the main key to find the <code>Assignment</code> object.
     * <p>
     *
    ...
    public Assignment findSingle(Assignment targetObject, String targetKey, FindData findData, ClientContext ctx, Session session) {
        ...
        if (resultObject == null) {
            ...
            if (primaryKey == null && keyAttributes == null && findData == null) {
                Object[] args = { "Assignment", "Assignment_os" };
     ...
     */
    public Assignment save(Assignment targetObject, ClientContext ctx, Session session) {
     ...
     */
    Assignment insert(Assignment targetObject, ClientContext ctx, Session session) {
        boolean setsContainAllRelated = getCurrentObjectSelection().getSetsContainAllRelated();
        Assignment resultObject;
    ...
    public Assignment insertSingle(Assignment targetObject, String targetKey, FindData findData, ClientContext ctx, Session session) {
        ...
        if (!isIdentical(targetObject,resultObject)) {
            ...
            TriggerInvoker.invoke(resultObject,TriggerType.INSERT, getCurrentObjectSelection().getTargetRoleName().equals("Assignment"), ctx, session);
     ...
     */
    public Assignment update(Assignment targetObject, ClientContext ctx, Session session) {
        boolean setsContainAllRelated = getCurrentObjectSelection().getSetsContainAllRelated();
        Assignment resultObject;
    ...
    public Assignment updateSingle(Assignment targetObject, String targetKey, FindData findData, ClientContext ctx, Session session) {
        ...
        if (resultObject == null) {
            ...
            if (resultObject != null) {
                ...
                TriggerInvoker.invoke(resultObject,TriggerType.UPDATE, getCurrentObjectSelection().getTargetRoleName().equals("Assignment"), ctx, session);
            }
            else {
                Object[] args = { "Assignment", "Assignment_os" };
     ...
     * @param session The <code>DataAccess</code> <code>Session</code>.
     */
        public void delete(Assignment targetObject,ClientContext ctx,Session session) {
        Assignment resultObject = null;
    ...
    public void deleteSingle(Assignment object,ClientContext ctx,Session session) {
        if (hookDeleteSingleStart(object,ctx,session)) {
            ...
            TriggerInvoker.invoke(object,TriggerType.DELETE, getCurrentObjectSelection().getTargetRoleName().equals("Assignment"), ctx, session);
        }
    ...
    /**
     * This method is part of the <code>Manager</code> Interface and connects a target object of class <code>Assignment</code> to its parent node.
    ...
    /**
     * This method is part of the <code>Manager</code> Interface and disconnects a target object of class <code>Assignment</code> from its parent node.
     * This is a root role and the method is dummy.
     *
     * @param objectSelection The object selection with all data from the client.
     * @param ctx The <code>ClientContext</code> desciption.
