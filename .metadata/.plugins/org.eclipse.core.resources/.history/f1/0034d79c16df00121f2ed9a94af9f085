...
public interface CourseAppConst {
    ...
    public static interface DialogObject {
        ...
        /** The MenuItem AddNewCourse component */
        String ADD_NEW_COURSE = "AddNewCourse";

        /** The MenuItem AddStudents component */
        String ADD_STUDENTS = "AddStudents";

        /** The MenuItem Exit component */
        String EXIT = "Exit";
