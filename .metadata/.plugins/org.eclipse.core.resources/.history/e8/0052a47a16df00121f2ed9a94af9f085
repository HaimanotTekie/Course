...
package no.course.service.application.office.answer_os;
...
/**
 * The <code>Answer_osOsManager</code> class was generated by the Genova Service Generator from the object selection <code>Answer_os</code>.
 * <p>
...
public class Answer_osOsManager extends OsManager {
    ...
    public static Role newRoleManager(String applicationName, String roleName) {
        ...
        String fullName = OsManager.createManagerClassName(roleName,"no.course.service.application.office.answer_os");
        try {
    ...
    public Role newManager(String applicationName, String roleName) {
        return Answer_osOsManager.newRoleManager(applicationName,roleName);
    }
