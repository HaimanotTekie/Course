...
/**
 * The <code>Course_osOsManager</code> class was generated by the Genova Service Generator from the object selection <code>Course_os</code>.
 * <p>
...
public class Course_osOsManager extends OsManager {
    ...
    public static Role newRoleManager(String applicationName, String roleName) {
        ...
        String fullName = OsManager.createManagerClassName(roleName,"no.course.service.application.office.course_os");
        try {
    ...
    public Role newManager(String applicationName, String roleName) {
        return Course_osOsManager.newRoleManager(applicationName,roleName);
    }
