...
public class CourseController extends CourseDefaultController {
    ...
    @Override
    protected CourseDefaultView hookInstantiateView(CourseDefaultController controller, GenovaEnums applicationEnums) {
        return new CourseView(controller, applicationEnums);
    }
}
