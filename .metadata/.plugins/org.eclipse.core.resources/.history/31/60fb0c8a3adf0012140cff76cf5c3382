...
public class AddStudentsToCourse_applRepository implements GenovaRepository {
    ...
    /** Default constructor */
    public AddStudentsToCourse_applRepository() {
        colors.put("Black", new Color(0,0,0));
        fonts.put("Standard", new Font("Tahoma", Font.PLAIN, FontTools.calcFontSize(8)));
        images.put("Clear", new ImageProxy("newSmall.gif"));
        images.put("Delete", new ImageProxy("deleteSmall.gif"));
        images.put("Save", new ImageProxy("saveSmall.gif"));
