...
public class ChooseStudentsController extends ChooseStudentsDefaultController {
    ...
    @Override
    protected ChooseStudentsDefaultView hookInstantiateView(ChooseStudentsDefaultController controller, GenovaEnums applicationEnums) {
        return new ChooseStudentsView(controller, applicationEnums);
    }
}
