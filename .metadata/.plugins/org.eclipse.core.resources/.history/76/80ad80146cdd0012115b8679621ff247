...
package example.service.application.office.courseapp_os;
...
public class CourseApp_osOsManager extends OsManager {
    ...
    public static Role newRoleManager(String applicationName, String roleName) {
        ...
        String fullName = OsManager.createManagerClassName(roleName,"example.service.application.office.courseapp_os");
        try {
