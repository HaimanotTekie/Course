...
/**
 * The <code>StudentDefaultManager</code> class is generated by the Genova Service Generator from the object selection <code>AddStudentsToCourse_os</code>.
 * <p>
 ...
 * <p>
 * The <code>student</code> is a leaf role in the object selection <code>AddStudentsToCourse_os</code>
 * <p>
    ...
    */
    ...
    public Student findSingle(Student targetObject, String targetKey, FindData findData, ClientContext ctx, Session session) {
        ...
        if (resultObject == null) {
            ...
            if (primaryKey == null && keyAttributes == null && findData == null) {
                Object[] args = { "Student", "AddStudentsToCourse_os" };
    ...
    public void saveAsRelated(StudentCourse parentObject, boolean setsContainAllRelated, ClientContext ctx, Session session) {
        if (hookSaveAsRelatedStart(parentObject,ctx,session)) {
            ...
            {
                Object[] args = { "StudentCourse", "Student", "AddStudentsToCourse_os" };
