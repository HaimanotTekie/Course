...
// ---------------------------------------------------------------------
package example.dialog.student;
...
public class StudentMethods extends AbstractNode<Student> {
    ...
    StudentMethods(StudentDefaultView view, StudentDefaultController controller, GenovaEnums genovaEnums) {
        this.view = view;
    ...
    */
    ...
    view.StudentClass.setVisible(b);
    
    /* Her kommer generert kode for SimpleBlock:setShown*/
    
    view.StudentData.setVisible(b);
    view.StudentAgeLabelLabel.setVisible(b);
    view.StudentIdLabelLabel.setVisible(b);
    view.StudentNameLabelLabel.setVisible(b);
    view.StudentStudentNrLabelLabel.setVisible(b);
    
    /* Her kommer generert kode for SimpleBlock:setShown*/
    
    view.StudentButton.setVisible(b);
    }
    ...
    if (s.equals("StudentClass")) {
        view.StudentClass.setVisible(b);
    }
    
    /* Her kommer generert kode for SimpleBlock:setShownField*/
    
    if (s.equals("StudentData")) {
        view.StudentData.setVisible(b);
    }
        if (s.equals("StudentAgeLabel")) {
            view.StudentAgeLabelLabel.setVisible(b);
        }
        if (s.equals("StudentIdLabel")) {
            view.StudentIdLabelLabel.setVisible(b);
        }
        if (s.equals("StudentNameLabel")) {
            view.StudentNameLabelLabel.setVisible(b);
        }
        if (s.equals("StudentStudentNrLabel")) {
            view.StudentStudentNrLabelLabel.setVisible(b);
        }
    ...
    if (view.StudentClass.isEnabled()) b=true;
    
    /* Her kommer generert kode for SimpleBlock:isShownField*/
    
    if (s.equals("StudentClass")) {
        if (view.StudentClass.hasFocus()) b=true;
    }
    
    /* Her kommer generert kode for SimpleBlock:isShown*/
    
    if (view.StudentData.isEnabled()) b=true;
    if (view.StudentAgeLabelLabel.isEnabled()) b=true;
    if (view.StudentIdLabelLabel.isEnabled()) b=true;
    if (view.StudentNameLabelLabel.isEnabled()) b=true;
    if (view.StudentStudentNrLabelLabel.isEnabled()) b=true;
    
    /* Her kommer generert kode for SimpleBlock:isShownField*/
    
    if (s.equals("StudentData")) {
        if (view.StudentData.hasFocus()) b=true;
    }
        if (s.equals("StudentAgeLabel")) {
            if (view.StudentAgeLabelLabel.hasFocus()) b=true;
        }
        if (s.equals("StudentIdLabel")) {
            if (view.StudentIdLabelLabel.hasFocus()) b=true;
        }
        if (s.equals("StudentNameLabel")) {
            if (view.StudentNameLabelLabel.hasFocus()) b=true;
        }
        if (s.equals("StudentStudentNrLabel")) {
            if (view.StudentStudentNrLabelLabel.hasFocus()) b=true;
        }
    
    /* Her kommer generert kode for SimpleBlock:isShown*/
    
    if (view.StudentButton.isEnabled()) b=true;
    
    /* Her kommer generert kode for SimpleBlock:isShownField*/
    
    if (s.equals("StudentButton")) {
        if (view.StudentButton.hasFocus()) b=true;
    }
       return b;
    }
