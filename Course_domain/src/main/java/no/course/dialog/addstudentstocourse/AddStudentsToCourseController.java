...
/** Skeleton class of AddStudentsToCourse. This class will only be
 * generated once. Add all user specific code here. (This should be
 * overriding of event methods). */
public class AddStudentsToCourseController extends AddStudentsToCourseDefaultController {

    /** Internal use. Use window open event defined in genova to add
     * code to dialog startup.
     * @param m The application methods.
     */
    public AddStudentsToCourseController(ApplicationMethods m) {
        super(m);
    }
    /**
    ...
    @Override
    protected AddStudentsToCourseDefaultView hookInstantiateView(AddStudentsToCourseDefaultController controller, GenovaEnums applicationEnums) {
    	setServerApplicationName("CourseMain");
        return new AddStudentsToCourseView(controller, applicationEnums);
    }
}
