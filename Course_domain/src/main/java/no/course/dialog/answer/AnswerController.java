...
public class AnswerController extends AnswerDefaultController {
    ...
    @Override
    protected AnswerDefaultView hookInstantiateView(AnswerDefaultController controller, GenovaEnums applicationEnums) {
        return new AnswerView(controller, applicationEnums);
    }
}
