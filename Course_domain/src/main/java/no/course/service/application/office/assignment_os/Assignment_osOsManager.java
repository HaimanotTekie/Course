...
/**
 * The <code>Assignment_osOsManager</code> class was generated by the Genova Service Generator from the object selection <code>Assignment_os</code>.
 * <p>
...
public class Assignment_osOsManager extends OsManager {
    ...
    public static Role newRoleManager(String applicationName, String roleName) {
        ...
        String fullName = OsManager.createManagerClassName(roleName,"no.course.service.application.office.assignment_os");
        try {
    ...
    public Role newManager(String applicationName, String roleName) {
        return Assignment_osOsManager.newRoleManager(applicationName,roleName);
    }
