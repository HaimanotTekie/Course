...
package no.course.service.application.office.student_os.generated;
...
/**
 * The <code>StudentDefaultManager</code> class is generated by the Genova Service Generator from the object selection <code>Student_os</code>.
 * <p>
 ...
 * <p>
 * <code>Student</code> is a root role.
 * <p>
 * The <code>Student</code> is a leaf role in the object selection <code>Student_os</code>
 * <p>
...
abstract public class StudentDefaultManager extends Role {
    ...
    */
     ...
     * @return The <code>Student</code> object
     */
     ...
     *
     * @param objectSelection The <code>ObjectSelection></code> to search
     * @return <code>Student</code> is a root role. The method always return null.
     */
    ...
    final void changeRootObject(ObjectSelection objectSelection, Student oldRoot, Student newRoot) {
        if (objectSelection != null) {
            Collection collection = objectSelection.getRootObjects("Student");
            if (collection != null) {
